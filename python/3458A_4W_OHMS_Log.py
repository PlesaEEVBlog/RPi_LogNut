...
LogDir = '/pub/logs/'
LogFile= LogDir + '3458A_4W_OHMS_Log.csv'
LogFile_ACAL= LogDir + '3458A_ACAL_OHMS_Log.csv'

# Setup HP 3458A
inst.write("PRESET NORM")
inst.write("OFORMAT ASCII")
inst.write("FUNC OHMF")
inst.write("OHMF 10000")
inst.write("OCOMP ON")
#inst.write("DCV 10")
...
while True:
  with open(LogFile, 'a') as MeterLog:
    ...
    if (abs(ACAL_Temperature - Temperature) >= ACAL_Treshold) or (time.time() - Last_ACAL_TimeStamp >= ACAL_TimeInterval):
        ...
        print('Performing ACAL OHMS, it will takes 12 minutes')
        ACAL_Counter+=1
        inst.write("ACAL OHMS")
